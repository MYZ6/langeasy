...
public class S1TranscriptCapture {
	...
	public static void main(String[] args) throws Exception {
		...
		if (total > -1) {
			// parseStory("http://genius.com/Serial-podcast-episode-12-what-we-know-annotated");
			// return;
		}
		S1TranscriptCapture downloader = new S1TranscriptCapture();
	...
	private static void parseStory(String link) throws Exception {
		...
		Element transcriptEle = doc.select(".song_body-lyrics").get(0);
