package com.chenyi.langeasy.capture.podcast.hiddenbrain;
...
public class EpisodeListCapture {
	private static String dirPath = "E:/langeasy/lucene/podcast/hidden-brain/";
	...
	public static void archive(int start) throws FileNotFoundException, IOException, ParseException {
		String url = "http://www.npr.org/series/423302056/hidden-brain/archive?start=" + start + "&date=2017-10-28";
