package com.chenyi.langeasy.capture.podcast.weekendeditionsunday;
...
public class EpisodeListCapture {
	...
	private static String dirPath = "E:/langeasy/lucene/podcast/weekend-edition-sunday/";
	...
	public static void archive(int year, String lastEdate, String lastEid, String minDate)
		...
		String url = "http://www.npr.org/programs/weekend-edition-sunday/archive";
		if (lastEdate != null) {
